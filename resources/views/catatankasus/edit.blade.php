                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="hidden" name="kdsiswa" id="kdsiswa"
                                    value="{{ old('kdsiswa', $catatankasus->kdsiswa) }}">
                                <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror"
                                    placeholder="Nama Siswa" id="nama_lengkap" name="nama_lengkap" aria-label="Nama Siswa"
                                    value="{{ old('nama_lengkap', $catatankasus->fsiswa->nama_lengkap) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="kdkompetensi" id="kdkompetensi"
                                value="{{ old('kdkompetensi', $catatankasus->kdkompetensi) }}">
                            <input type="text" class="form-control @error('kompetensi_keahlian') is-invalid @enderror"
                                ...
                                value="{{ old('kompetensi_keahlian', $catatankasus->fsiswa->fkompetensi->kompetensi_keahlian) }}"
                                readonly>
                        ...
                        <div class="form-group">
                            ...
                            <select name="semester" id="semester" class="form-control">
                                @foreach ($semester as $semester)
                                    <option value="{{ $semester->keterangan }}"
                                        {{ old('semester', $catatankasus->semester) == $semester->keterangan ? 'selected' : '' }}>
                                        {{ $semester->keterangan }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_ajaran', $catatankasus->tahun_ajaran) }}">
                            @error('tahun_ajaran')
                                <span class="text danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kasus') is-invalid @enderror" id="kasus"
                                placeholder="Kasus" name="kasus" value="{{ old('kasus', $catatankasus->kasus) }}">
                            @error('kasus')
                                <span class="text danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                placeholder="Tanggal" name="tanggal" value="{{ old('tanggal', $catatankasus->tanggal) }}">
                            @error('tanggal')
                                <span class="text danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tindak_lanjut') is-invalid @enderror"
                                ...
                                value="{{ old('tindak_lanjut', $catatankasus->tindak_lanjut) }}">
                            @error('tindak_lanjut')
                                <span class="text danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('status_kasus') is-invalid @enderror"
                                ...
                                value="{{ old('status_kasus', $catatankasus->status_kasus) }}">
                            @error('status_kasus')
                                <span class="text danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('dampingan_bk') is-invalid @enderror" id="dampingan_bk"
                                name="dampingan_bk">
                                <option value="Tidak"
                                    {{ old('dampingan_bk', $catatankasus->dampingan_bk) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak
                                </option>
                                <option value="Ya"
                                    {{ old('dampingan_bk', $catatankasus->dampingan_bk) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                            @error('dampingan_bk')
                                <span class="text-danger">{{ $message }}</span>
