    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" placeholder="Nama Siswa" id="nama_lengkap" name="nama_lengkap" aria-label="Nama Siswa" value="{{ old('nama_lengkap') }}" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kasus') is-invalid @enderror" id="kasus" placeholder="Kasus" name="kasus" value="{{ old('kasus') }}">
                        @error('kasus')
                        <span class="text danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('tindak_lanjut') is-invalid @enderror" id="tindak_lanjut" placeholder="Tindak Lanjut" name="tindak_lanjut" value="{{ old('tindak_lanjut') }}">
                @error('tindak_lanjut')
                <span class="text danger">{{ $message }}</span>
                @enderror
            </div>
