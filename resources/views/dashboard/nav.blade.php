...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            <img src="../assets/img/logos/Sija Cafe.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Homeroom Apps</span>
        </a>
    </div>
    ...
    <div class="navbar-nav">
        <ul class="navbar-nav">
            ...
            {{-- Menu Rencana Kegiatan--}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('rencanakegiatan.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Rencana Kegiatan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('struktur.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Struktur Organisasi Kelas</span>
                </a>
            </li>
            ...
            {{-- Menu Kompetensi Keahlian --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kompetensi.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Kompetensi Keahlian</span>
                </a>
            </li>
            ...
            {{-- Menu Presentase Sosial Ekonomi --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('presentase.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Presentase Sosial Ekonomi</span>
                </a>
            </li>

            {{-- Menu Catatan Kasus --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('catatankasus.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Catatan Kasus</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kunjunganrumah.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Kunjungan Rumah</span>
                </a>
            </li>
            ...
            {{-- Menu Jadwal Piket --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('jadwalpiket.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- Menu Daftar Rapot --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('daftarrapot.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Daftar Rapor</span>
                </a>
            </li>

            {{-- Menu Siswa Kesiswaan --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('siswakes.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Siswa (Kesiswaan)</span>
                </a>
            </li>

            {{-- Menu Laporan Kasus --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('laporankasus.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Laporan Kasus Kesiswaan</span>
                </a>
            </li>


            {{-- Menu Laporan Kasus Kakom --}}
            <li class="nav-item">
            ...
            {{-- Menu Laporan Kasus BK--}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('laporan.kasus.bk') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Laporan Kasus BK</span>
                </a>
            </li>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('rencanakegiatan.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Rencana Kegiatan Walikelas</span>
                </a>
            </li>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="navbar-nav">
        <ul class="navbar-nav">
            ...
            {{-- Menu Daftar Kasus --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pembinaanbk.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Daftar Kasus</span>
                </a>
            </li>

            {{-- Menu Dalam Pembinaan --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pembinaanbk.pembinaan') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Daftar Pembinaan</span>
                </a>
            </li>

            {{-- Menu Kasus Selesai --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pembinaanbk.selesai') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Kasus Selesai</span>
                </a>
            </li>
        </ul>
    </div>
...
{{-- Tampilkan menu hanya untuk kesiswaan --}}
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="navbar-nav">
        <ul class="navbar-nav">
            ...
            {{-- Menu Data Siswa --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kesiswaan.siswa') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- Menu Laporan Kasus --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kesiswaan.kasus') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- Menu Kasus Selesai --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kesiswaan.kasusSelesai') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
