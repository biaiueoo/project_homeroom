            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas" placeholder="Kelas" name="kelas" value="{{ old('kelas', $kelas->kelas) }}">
                        @error('kelas')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="kdkompetensi" id="kdkompetensi" value="{{ old('kdkompetensi', $kelas->kdkompetensi) }}">
                            <input type="text" class="form-control @error('kompetensi_keahlian') is-invalid @enderror" placeholder="Kompetensi Keahlian" id="kompetensi_keahlian" name="kompetensi_keahlian" aria-label="Kompetensi Keahlian" value="{{ old('kompetensi_keahlian', $kelas->fkompetensi->kompetensi_keahlian) }}" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="guru_nip" id="guru_nip" value="{{ old('guru_nip', $kelas->guru_nip) }}">
                            <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" placeholder="Kepala Program" id="nama_guru" name="nama_guru" aria-label="Kepala Program" value="{{ old('nama_guru', $kelas->fguru->nama_guru) }}" aria-describedby="cari" readonly>
...
@error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran" placeholder="Tahun Ajaran" name="tahun_ajaran" value="{{ $kelas->tahun_ajaran ?? old('tahun_ajaran') }}">
                        @error('tahun_ajaran')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
