            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('keperluan') is-invalid @enderror" id="keperluan" placeholder="Keperluan" name="keperluan" value="{{old('keperluan')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('ttd') isinvalid @enderror" type="file" id="ttd" name="ttd">
                            @error('ttd') <span class="textdanger">{{$message}}</span> @enderror
                        </div>

                        
                        <div class="form-group">
                            <label for="tahun_ajaran">Tahun Ajakan</label>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('bukutamu.index')}}" class="btn btn-default">
                                Batal
                            </a>
                        </div>
                    </div>
