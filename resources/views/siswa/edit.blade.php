                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kdkelas') is-invalid @enderror"
                                placeholder="Kelas" id="kelas" name="kelas" aria-label="Kelas"
                                value="{{ $siswa->fkelas->kelas }}" aria-describedby="cari" readonly>
                        </div>

                        <!-- Kompetensi Keahlian -->
                        <div class="form-group">
                            <label for="kdkompetensi">Kompetensi Keahlian</label>
                            <input type="text" class="form-control @error('kdkompetensi') is-invalid @enderror"
                                placeholder="Kompetensi Keahlian" id="kdkompetensi" name="kdkompetensi"
                                aria-label="Kompetensi Keahlian" value="{{ $siswa->fkompetensi->kompetensi_keahlian }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                                placeholder="No HP" name="no_hp" value="{{ $siswa->no_hp }}">
                            @error('no_hp')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                id="email" placeholder="Email" name="email" value="{{ $siswa->email }}">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                                id="nisn" placeholder="NISN" name="nisn" value="{{ $siswa->nisn }}">
                            @error('nisn')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('alamat_ortu') is-invalid @enderror" id="alamat_ortu" name="alamat_ortu"
                                placeholder="Alamat Ortu">{{ $siswa->alamat_ortu }}</textarea>
                            @error('alamat_ortu')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('no_ortu') is-invalid @enderror"
                                id="no_ortu" placeholder="No Ortu" name="no_ortu" value="{{ $siswa->no_ortu }}">
                            @error('no_ortu')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('alamat_sekolah') is-invalid @enderror" id="alamat_sekolah"
                                name="alamat_sekolah" placeholder="Alamat Sekolah">{{ $siswa->alamat_sekolah }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('alergi') is-invalid @enderror"
                                id="alergi" placeholder="Alergi" name="alergi" value="{{ $siswa->alergi }}">
                            @error('alergi')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="prestasi_non_akademik" value="{{ $siswa->prestasi_non_akademik }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('biografi') is-invalid @enderror" id="biografi" name="biografi"
                                placeholder="Biografi">{{ $siswa->biografi }}</textarea>
                            @error('biografi')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
